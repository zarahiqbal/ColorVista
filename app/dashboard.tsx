...
// // // Props include navigation callback
// // export const Dashboard = ({ onGoToWelcome }: { onGoToWelcome?: () => void }) => {
// //   return (
...
// //       {toolsData.map(tool => (
// //         <TouchableOpacity key={tool.title} style={styles.toolCard}>
// //           {tool.icon}
...
// // 🔥 Tools data updated with "screen"
// const toolsData = [
//   {
//     title: 'Live Detection',
//     screen: 'LiveDetection',
//     icon: <Feather name="camera" size={28} color={COLORS.primary} />,
//   },
//   {
//     title: 'Media Upload',
...
// // MAIN DASHBOARD
// export const Dashboard = ({ navigation, onGoToWelcome }: any) => {
//   return (
//     <SafeAreaView style={styles.safeArea}>
//       <StatusBar barStyle="dark-content" backgroundColor={COLORS.background} />
...
//         <SearchBar />
//         <GameProgress />
//         {/* Pass navigation to ToolsSection */}
...
// const ToolsSection = ({ navigation }: any) => (
//   <View style={styles.section}>
//     <Text style={styles.sectionTitle}>Choose a tool to get started</Text>
...
//           onPress={() => navigation.navigate(tool.screen)} // 🔥 Navigate to screen
//         >
//           {tool.icon}
//           <Text style={styles.toolLabel}>{tool.title}</Text>
//         </TouchableOpacity>
