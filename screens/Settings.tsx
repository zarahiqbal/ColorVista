...
export default function SettingsPage() {
  ...
  // 2. Added Contact Support Handler
        ...
        [
          {
            text: "Copy Email",
            onPress: () => {
              // Ideally you would import Clipboard here
            },
          },
          { text: "OK" },
        ],
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      >
              ...
              <View style={styles.dropdownContainer}>
                ...
                >
                  <View style={styles.rowLabel}>
                    ...
                    <Text style={[styles.rowText, dText(16)]}>
                      Color Blind Mode
                    </Text>
                  </View>
              ...
              {["Small", "Medium", "Large"].map((size) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    {
                      borderColor:
                        fontSize === size ? palette.sage : theme.border,
                      backgroundColor:
                        fontSize === size ? palette.sage : "transparent",
                    },
                  ]}
          ...
          {!isGuest && (
            <>
              ...
              >
                <View style={styles.rowLabel}>
                  <View
                    style={[styles.iconBox, { backgroundColor: theme.iconBg }]}
                  >
                    <Ionicons
                ...
                <View style={styles.progressBarBackground}>
                  <View
                    style={[
                      ...
                      { width: "78%", backgroundColor: palette.sage },
                    ]}
                  />
                </View>
              </View>
        ...
        >
          ...
          {/* 3. Connected Contact Support Button */}
            ...
            <View style={{ alignItems: "center", marginBottom: 20 }}>
              <View
                style={[
                  styles.iconBox,
                  {
                    backgroundColor: isGuest ? palette.sage : "#FF3B30",
                    width: 50,
                    height: 50,
                    borderRadius: 25,
                    marginBottom: 12,
              ...
              >
                <Ionicons
                  name={isGuest ? "person-add-outline" : "log-out-outline"}
                  size={26}
                  color="#FFF"
                />
              </View>
