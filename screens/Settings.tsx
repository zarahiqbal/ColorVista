...
//                   <Text style={styles.valueText}>{colorBlindMode}</Text>
//                   <Feather name={isDropdownOpen ? "chevron-up" : "chevron-down"} size={20} color="#666" />
//                 </View>
//              </TouchableOpacity>
...
//              <View style={styles.rowLabel}>
//                 <MaterialIcons name="format-size" size={22} color="#333" />
...
//                  <TouchableOpacity 
//                     key={size} 
//                     style={[styles.radioButton, fontSize === size && styles.radioButtonSelected]}
//                     onPress={() => setFontSize(size)}
//                  >
//                    <Text style={[styles.radioText, fontSize === size && styles.radioTextSelected]}>
//                      {size}
//                    </Text>
//                  </TouchableOpacity>
//                ))}
...
//         <Text style={styles.sectionHeader}>USER ACTIVITY</Text>
//         <View style={styles.section}>
//           <View style={styles.activityRow}>
//              <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8}}>
//                 <Text style={styles.rowText}>Color Accuracy</Text>
//                 <Text style={{fontWeight: 'bold', color: '#4CAF50'}}>78%</Text>
//              </View>
//              {/* Custom Progress Bar */}
...
//     marginLeft: 50, // Indented separator
//   },
//   // User Card Styles
//   userCard: {
//     flexDirection: 'row',
...
//     fontWeight: '600',
//   },
//   // Radio Styles (Font Size)
//   radioGroup: {
//     flexDirection: 'row',
//     marginTop: 12,
//     marginLeft: 34, // Indent to align with label text
//   },
//   radioButton: {
//     paddingVertical: 6,
