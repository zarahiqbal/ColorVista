    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.textContainer}>
          <Text
            style={[styles.title, { color: theme.text, fontSize: 28 * scale }]}
          >
            Coming Soon
          </Text>
          ...
          <Text
            style={[
              styles.subtitle,
              { color: brandColors.tan, fontSize: 22 * scale },
            ]}
          >
            {displayTitle}
          </Text>
          ...
          >
            We are crafting this feature with care. It will be available in the
            next update.
          </Text>
        </View>
