...
const INSPIRATION_FEED = [
  ...
  // --- NATURE ---
  {
    ...
    author: "Sarah J.",
    image:
      "https://images.unsplash.com/photo-1485627658391-1365e4e0dbfe?q=80&w=800&auto=format&fit=crop",
    tag: "Nature",
    likes: 89,
  },
  {
      ...
      >
        ...
        {activeCategory === "All" && (
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, dText(18)]}>
              Featured Palette
            </Text>
            <View
              style={[styles.featuredCard, { backgroundColor: palette.taupe }]}
            >
              <View style={styles.featuredContent}>
                ...
                <Text style={[styles.featuredDesc, { fontSize: 14 * scale }]}>
                  High contrast ratios tested for Protanopia and Deuteranopia
                  visibility.
                </Text>
                ...
                <View style={styles.paletteRow}>
                  {["#2F2F2F", "#F6F3EE", "#8DA399"].map((c, i) => (
                    <View
                      key={i}
                      style={[styles.swatchLarge, { backgroundColor: c }]}
                    />
                  ))}
          ...
          <View style={styles.section}>
            ...
            >
              {PALETTES.map((p, idx) => (
                <View
                  key={idx}
                  style={[styles.paletteCard, { backgroundColor: theme.card }]}
                >
