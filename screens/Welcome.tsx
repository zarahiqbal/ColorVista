...
const Hero: React.FC<{ pulseAnim: Animated.Value }> = ({ pulseAnim }) => (
  <View style={styles.hero}>
    ...
    <Text style={styles.heroSub}>
      Ishihara-based color deficiency screening{"\n"}
      with intelligent pattern analysis
    </Text>
...
// ─── Disclaimer ────────────────────────────────────────────────────────────────
const Disclaimer: React.FC<{ darkMode: boolean }> = ({ darkMode }) => (
  <View
    style={[
      styles.disclaimer,
      {
        backgroundColor: darkMode ? DARK.amberLight : TOKENS.amberLight,
        borderColor: darkMode ? "#4A2B00" : "#F0D4B0",
      },
    ]}
  >
    <View
      style={[
        styles.discIcon,
        {
          backgroundColor: darkMode ? "#3A2400" : "#FDE8CC",
        },
      ]}
    >
      <AlertTriangle size={16} color={TOKENS.amber} strokeWidth={2} />
    ...
    <View style={styles.discContent}>
      ...
      <Text
        style={[
          styles.discBody,
          {
            color: darkMode ? "#D6B38A" : "#8B5000",
          },
        ]}
      >
        This screening is for informational purposes only and does not replace
        an evaluation by a licensed optometrist or ophthalmologist.
      </Text>
    </View>
  </View>
);
...
const StepRow: React.FC<{
  ...
  isLast: boolean;
  darkMode: boolean;
}> = ({ item, isLast, darkMode }) => (
  <View
    style={[
      styles.stepRow,
      !isLast && {
        borderBottomWidth: 1,
        borderBottomColor: darkMode ? DARK.border : TOKENS.border,
      },
    ]}
  >
    <View
    ...
    <View style={styles.stepInfo}>
      <Text
        style={[
          styles.stepTitle,
          {
            color: darkMode ? DARK.ink : TOKENS.ink,
          },
        ]}
      >
        {item.title}
      ...
      <Text
        style={[
          styles.stepDesc,
          {
            color: darkMode ? DARK.ink2 : TOKENS.ink3,
          },
        ]}
      >
        {item.desc}
  ...
  >
    ...
    <Text
      style={[
        styles.tipText,
        {
          color: darkMode ? DARK.ink2 : TOKENS.ink2,
        },
      ]}
    >
      {item.text}
    ...
    <View
      style={[
        styles.tipCheck,
        {
          borderColor: darkMode ? DARK.border2 : TOKENS.border2,
        },
      ]}
    >
      <CheckCircle
        size={13}
        color={darkMode ? DARK.ink2 : TOKENS.ink4}
        strokeWidth={1.5}
      />
    </View>
  </View>
