...
//             <View
//               style={[styles.stepCard, { backgroundColor: colors.accent1 }]}
//             >
...
//             </View>
//             <View
//               style={[styles.stepCard, { backgroundColor: colors.accent2 }]}
//             >
//               <View style={styles.stepIcon}>
//                 <Text style={styles.stepIconText}>□△</Text>
//               </View>
...
//             </View>
//             <View
//               style={[styles.stepCard, { backgroundColor: colors.accent3 }]}
//             >
//               <View style={styles.stepIcon}>
//                 <Text style={styles.stepIconText}>⚙</Text>
//               </View>
...
//             <View
//               style={[styles.featureCard, { backgroundColor: colors.accent1 }]}
//             >
...
//             </View>
//             <View
//               style={[styles.featureCard, { backgroundColor: colors.accent2 }]}
//             >
//               <CheckCircle color="white" size={28} />
//               <Text style={styles.featureTitle}>Accurate</Text>
//             </View>
//             <View
//               style={[styles.featureCard, { backgroundColor: colors.accent3 }]}
//             >
//               <Shield color="white" size={28} />
//               <Text style={styles.featureTitle}>Private</Text>
//             </View>
//             <View
//               style={[styles.featureCard, { backgroundColor: colors.accent4 }]}
//             >
...
//   /**
//    * FIX: Handle the native back action safely to prevent the "Console Error"
//    */
...
//               <Clock color="white" size={28} />
//               <Text style={styles.s.featureTitle}>Quick Test</Text>
//               <Text style={styles.s.featureSubtitle}>2-3 min</Text>
//             </View>
//             <View
//               style={[
//                 styles.s.featureCard,
...
//               { icon: "◎", text: "Take your time" },
//             ].map((tip, index) => (
//               <View key={index} style={styles.s.tipItem}>
//                 <View style={styles.s.tipIconCircle}>
//                   <Text style={styles.s.tipIconText}>{tip.icon}</Text>
//                 </View>
//                 <Text style={styles.s.tipText}>{tip.text}</Text>
