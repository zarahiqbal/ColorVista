...
//       <BottomNavBar onProfilePress={() => setShowProfileModal(true)} />

//       {/* Profile Modal - Functionality preserved from original code */}
//       <ProfileModal 
//         visible={showProfileModal} 
//         onClose={() => setShowProfileModal(false)} 
//       />
...
// // ---------------- BOTTOM NAV ----------------
// const BottomNavBar = ({ onProfilePress }: { onProfilePress?: () => void }) => {
//   const router = useRouter();
...
//         onPress={() => router.push('/handleprofile' as any)} 
...
//         onPress={() => router.push('/userprofile')}
//       >
//         <FontAwesome name="user" size={24} color={COLORS.lightText}  />
//         <Text style={styles.navLabel}>Profile</Text>
//       </TouchableOpacity>
//       {/* --- HOME BUTTON (Active) --- */}
//       <TouchableOpacity style={styles.navItem} activeOpacity={0.7}>
...
//   // Modal Styles (Preserved from Input 1)
//   modalOverlay: {
//     flex: 1,
//     backgroundColor: 'rgba(0, 0, 0, 0.5)',
//     justifyContent: 'flex-start',
